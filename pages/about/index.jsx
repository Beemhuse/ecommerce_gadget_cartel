    ...
    <div className="bg-gray-100 min-h-screen">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex justify-center items-center mb-8">
          <img src="/logo.svg" alt="Gadget Store Logo" className="h-16 w-16 mr-2" />
        ...
        <div className="flex justify-center mb-8">
          <img src="/smartphone.svg" alt="Smartphone Illustration" className="h-24 w-24 mx-2" />
          <img src="/tablet.svg" alt="Tablet Illustration" className="h-24 w-24 mx-2" />
        </div>
